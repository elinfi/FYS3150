...
void print_monte_carlo(int n, double lambda, bool timing) {
    double sum, variance, exact;
    ...
    tie(sum, variance) = monte_carlo(2*n, lambda, 1424);
...
void print_improved_monte_carlo(int n, bool timing) {
    double sum, variance, exact;
    ...
    tie(sum, variance) = improved_monte_carlo(n, time_t(0));
...
void print_parallellized_monte_carlo(int &nargs, char* args[], int n, double lambda, bool timing) {
    int numprocs, my_rank, flag;
    double time_start, time_end, total_time;
    double total_sum, local_sum, variance;
    ...
    if (my_rank == 0) {
        ...
        cout << "Relative Error: " << abs(exact - total_sum)/exact << endl;
        cout << "Variance: " << variance << endl;
...
void print_parallellized_improved_monte_carlo(int &nargs, char* args[], int n, bool timing) {
    int numprocs, my_rank, flag;
    double time_start, time_end, total_time;
    double total_sum, local_sum, variance;
...
//    print_parallellized_monte_carlo(nargs, args, n, lambda, timing);

    print_improved_monte_carlo(n, timing);
